...
Route::post('saving', [LoginController::class, 'store']);//ログイン情報を登録
Route::post('check_change_password', [LoginController::class,'only_check_password']);//パスワードのチェック
Route::put('check_change_password/{id}', [LoginController::class,'update']);//パスワードを更新
Route::get('get_information', [LoginController::class,'get_user_info']);//ログイン情報を入手
Route::get('get_id', [LoginController::class,'index']);//ログイン情報を入手
Route::get('confirm_token', [LoginController::class,'get_confirm']);//トークン
Route::put('post_reminder_update/{id}', [LoginController::class,'post_reminder_update']);//通知更新
Route::delete('logout/{id}', [LoginController::class,'delete']);//ログアウト
...
Route::post('reminder_send', [ReminderController::class, 'store']);//通知を設定
...
Route::post('img_account_post', [AccountController::class, 'img_post']);//プロフィール画像情報
...
Route::post('add_comment_data', [CommentController::class, 'store']);//コメント追加
Route::get('get_comment_data', [CommentController::class, 'index']);//コメント表示
